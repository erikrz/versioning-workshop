...
public class ContactsService {
    ...
    public Optional<ContactDto> updateContactById(Long id, CreateContactDto updatedContactDto) {
        ...
        contactToUpdate.setFirstName(updatedContactDto.getFirstName());
        contactToUpdate.setLastName(updatedContactDto.getLastName());
        contactToUpdate.setEmail(updatedContactDto.getEmail());
        contactToUpdate.setPhoneNumber(updatedContactDto.getPhoneNumber());
